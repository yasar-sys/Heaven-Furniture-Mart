      ...
      <Shell>
        <div className="grid gap-14 lg:grid-cols-12 lg:gap-20">
          <Reveal className="lg:col-span-4">
            <span className="eyebrow text-brass">{t("Since 2020 · Agrabad")}</span>
            <span className="mt-6 block rule-line w-16" />
          </Reveal>

          <div className="lg:col-span-8">
            <Reveal as="h2" className="display-lg max-w-[22ch]">
              {t("More than furniture.")}
              <br />
              <span className="italic text-brown">{t("A reflection of you.")}</span>
            </Reveal>
            ...
            <Reveal delay={120} as="blockquote" className="mt-12 max-w-2xl">
              ...
              <footer className="mt-8 text-[0.7rem] uppercase tracking-[0.24em] text-foreground">
                {t("— Abul Kalam Bhuiyan, Managing Director")}
              </footer>
            </Reveal>
          </div>
        </div>
