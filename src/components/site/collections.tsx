...
const COLLECTIONS: Collection[] = [
  ...
  },
  {
    id: "dining",
    title: "Dining",
    items: "Marble Dining Tables · Velvet Chairs · Crockery Cabinets",
    img: photo.diningPeachMarble,
    alt: "Heaven Furniture Mart luxury dining set with peach velvet diamond-tufted chairs and marble dining table under chandelier",
    interest: "Dining Set",
    room: "Dining",
    frame: "aspect-square",
    width: 1024,
    height: 1024,
    pieces: [
      { name: "Marble-top luxury dining table", note: "High-gloss marble with carved dark wood base." },
      { name: "Peach velvet tufted chairs", note: "Diamond back quilting with crown carved top." },
      { name: "Custom crockery cabinet", note: "Glass panelled display cabinet." },
    ],
  },
  {
    id: "office",
