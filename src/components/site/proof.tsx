...
const AWARDS = [
  ...
  },
  {
    ...
    note: "Honoured at the 14th Chattogram Furniture Fair prize ceremony.",
    alt: "Heaven Furniture Mart founder receiving a plaque on stage at the 14th Chattogram Furniture Fair 2024",
    fit: "cover" as const,
    width: 1024,
    height: 768,
  },
...
export function Proof() {
  ...
  return (
    <Section id="awards" tone="muted" className="py-28 sm:py-36" label="Trust">
      <Shell>
